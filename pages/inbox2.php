  ...
  <section id="container">
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <h5 class="centered"> <?=$_SESSION["prenom_admin"]?> <?=$_SESSION["nom_admin"]?></h5>
          ...
          <li>
            <a class="active" href="inbox2.php">
              <i class="fa fa-envelope"></i>
              <span>EN COURS...  </span>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <?php if(isset($_GET["id"]) && $_GET["id"] == "maj") : ?>
          <div class="alert alert-success" role="alert">
              <h4 align="center">La demande a ete mis a jour avec succès :)</h4>
          </div>
        <?php elseif(isset($_GET["id"]) && $_GET["id"] == "en_cours") : ?>
          <div class="alert alert-success" role="alert">
            <h4 align="center">Nouvelle demande en cours de traitement ajouté :)</h4>
          </div>
        <?php endif ; ?>
        <div class="row mt">
          <div class="col-sm-12">
