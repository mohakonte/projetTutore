...
<body>
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Acces utilisateur</li>
		</ol>
				...
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							<h3 class="thin text-center">Inscrivez-vous à votre compte</h3>
							<p class="text-center text-muted">Si vous n'avez pas encore de compte, Cliquez sur <a href="signup.php">S'enregistrer</a> pour creer un nouveau compte. </p>
							<hr>
							
							<form  action="demandeExtrait.php">
